...
import static net.oz.string.SimpleStringHash.ensureCapacity;
import static net.oz.string.SimpleStringHash.firstReversePower;
import static net.oz.string.SimpleStringHash.secondReversePower;
